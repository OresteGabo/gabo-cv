            ...
            <article className="overflow-hidden rounded-3xl border border-outline/10 bg-background/75">
              <div className="flex items-center justify-between border-b border-outline/10 px-5 py-4">
                <div>
                  ...
                  <h3 className="mt-1 font-black">Bond market</h3>
                </div>
                <a href="https://rse.rw/bond-market" target="_blank" rel="noreferrer" className="text-xs font-black text-primary">
              ...
              {marketData.trades.length > 0 ? (
                  ...
                  {marketData.trades.map((trade) => (
                    <div key={trade.bond} className="p-5">
                      ...
                      <div className="mt-3 grid grid-cols-3 gap-3 text-xs">
                        <div>
                          <p className="text-[9px] uppercase tracking-wider text-outline">Closing</p>
                          <p className="mt-1 font-black">{trade.closing}</p>
                        </div>
                        <div>
                          <p className="text-[9px] uppercase tracking-wider text-outline">Change</p>
                          <p className="mt-1 font-black text-primary">{trade.change}</p>
                        </div>
                        <div>
                          <p className="text-[9px] uppercase tracking-wider text-outline">Value</p>
                          <p className="mt-1 font-black">RWF {trade.value}</p>
                        </div>
                      </div>
                    </div>
                  ))}
                ...
                <RseMarketErrorTable
                  ...
                  sourceName="RSE Bond Market"
                  sourceUrl="https://rse.rw/bond-market"
                />
              )}
            </article>
