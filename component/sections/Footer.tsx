...
import { Github, Linkedin, Cpu, ExternalLink, Twitter, Instagram, Phone } from 'lucide-react';
...
export const Footer = ({ lang }: FooterProps) => {
    const t = {
        ...
        socialLabels: {
            github: { en: "View GitHub Profile", fr: "Voir le profil GitHub" },
            linkedin: { en: "Connect on LinkedIn", fr: "Se connecter sur LinkedIn" },
            twitter: { en: "Follow on X (Twitter)", fr: "Suivre sur X (Twitter)" },
            instagram: { en: "Follow on Instagram", fr: "Suivre sur Instagram" },
            phone: { en: "Call or WhatsApp me", fr: "Appelez-moi ou WhatsApp" }
        }
    };
                ...
                <div className="grid grid-cols-1 md:grid-cols-12 gap-16 mb-24">
                    <div className="md:col-span-6">
                        ...
                        <div className="flex flex-wrap gap-4">
                            <a
                                ...
                                aria-label={t.socialLabels.linkedin[lang]}
                            ...
                            <a
                                ...
                                target="_blank" rel="noopener noreferrer"
                                aria-label={t.socialLabels.github[lang]}
                                className="p-4 rounded-2xl border border-outline/10 bg-surface-container-low hover:border-primary/50 hover:text-primary transition-all duration-300 shadow-sm"
                            >
                                <Github size={20} />
                            </a>
                            <a
                                href="https://x.com/GaboOreste"
                                target="_blank" rel="noopener noreferrer"
                                aria-label={t.socialLabels.twitter[lang]}
                                className="p-4 rounded-2xl border border-outline/10 bg-surface-container-low hover:border-primary/50 hover:text-primary transition-all duration-300 shadow-sm"
                            >
                                <Twitter size={20} />
                            </a>
                            <a
                                href="https://instagram.com/oreste_gabo"
                                target="_blank" rel="noopener noreferrer"
                                aria-label={t.socialLabels.instagram[lang]}
                                className="p-4 rounded-2xl border border-outline/10 bg-surface-container-low hover:border-primary/50 hover:text-primary transition-all duration-300 shadow-sm"
                            >
                                <Instagram size={20} />
                            </a>
                            {/* WhatsApp / Phone Link */}
                            <a
                                href="https://wa.me/33769097991"
                                target="_blank" rel="noopener noreferrer"
                                aria-label={t.socialLabels.phone[lang]}
                                className="p-4 rounded-2xl border border-outline/10 bg-surface-container-low hover:border-primary/50 hover:text-primary transition-all duration-300 shadow-sm"
                            >
                                <Phone size={20} />
                            </a>
                    ...
                    <div className="md:col-span-6 flex flex-col items-end justify-center">
                        <motion.a
                            ...
                            aria-label={`Envoyer un email à ${SITE_CONFIG.email}`}
